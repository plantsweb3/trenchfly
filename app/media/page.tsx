...
export const metadata: Metadata = {
  ...
  openGraph: { title, description, url: `${SITE_URL}/media`, type: "website", images: [{ url: "/media/art/robinfly-small-brain-public-record-landscape.png", width: 1672, height: 941, alt: "RobinFly campaign art: Small brain. Public record." }] },
  twitter: { card: "summary_large_image", title, description, creator: SOCIAL_HANDLE, images: ["/media/art/robinfly-small-brain-public-record-landscape.png"] },
};
...
const downloads = [
  ...
  ["Recorded observation", "Timestamped paper evidence · PNG", "social/recorded-observation.png"],
  ...
  return <div className={s.page}>
    ...
    <main id="media-main">
      ...
      <figure className={s.campaign}>
        <Image src="/media/art/robinfly-small-brain-public-record-landscape.png" width={1672} height={941} alt="RobinFly at a miniature trading desk under lime and blue light. Small brain. Public record. Paper experiment." sizes="(max-width: 800px) 100vw, 1280px" priority />
        <figcaption><span>Campaign illustration / Small brain. Public record.</span><a href="/media/art/robinfly-small-brain-public-record-landscape.png" download>Download original ↓</a></figcaption>
      </figure>
