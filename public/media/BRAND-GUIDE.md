# RobinFly — launch identity

**RobinFly** · **@RobinFlyPons** · **robinfly.net**

The promise: **Small brain. Public record.**
...
| Lime accent | #D7FF3F |
| Main text | #F3F5E7 |
| Secondary text | #AFBBA8 |
| Borders | #2C382A |
| Eyes / sell | #FF655D |
| Right motor | #93D5F7 |
| Paper / caution | #F4BA63 |

The site uses IBM Plex Sans and IBM Plex Mono. Editable launch layouts use Arial/Helvetica and Menlo fallbacks, so no font installation is required. Keep headlines short, large and tightly spaced. Use thin rules, open space and the native faceted fly. The full-color symbol retains coral eyes; preserve its proportions and clear space.

The X header leaves its lower-left region clear for the profile image. Check the profile preview when applying it because cropping varies across surfaces. Use the 800 px icon for the profile photo. Portrait and story graphics have their own compositions; use them rather than squeezing the landscape poster.

## Voice

Curious, dry, direct. Use concrete verbs and evidence. A little personality belongs around the character; scientific and execution claims should remain precise.
...
- `identity/`: reusable RobinFly wordmarks, symbol, avatar and color tokens.

The generated square poster includes a small generic leaf motif on the mug; it is decorative and is not the RobinFly identity mark. Use the provided fly symbol for brand identification.
